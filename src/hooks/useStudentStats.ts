...
export function useStudentStats() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('scholars_study_data_reset', handleResetOrUpdate);
    window.addEventListener('scholars_session_completed', handleResetOrUpdate);

    return () => {
      window.removeEventListener('scholars_study_data_reset', handleResetOrUpdate);
      window.removeEventListener('scholars_session_completed', handleResetOrUpdate);
    };
  }, [fetchStats]);
