...
3. Be clear, concise, and structured. Use step-by-step breakdowns for calculations or complex concepts.`
      ...
      setMessages([...updatedMessages, { role: 'assistant', content: 'I encountered an error connecting to my Groq brain. Please try again shortly.' }]);
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="fixed bottom-6 right-6 z-50">
      {!isOpen && (
        <Button 
          ...
          className="h-14 w-14 rounded-full shadow-2xl shadow-purple-500/30 bg-purple-600 hover:bg-purple-700 text-white relative group"
        >
        ...
        <Card className="w-80 sm:w-96 h-[560px] flex flex-col shadow-2xl border-purple-500/30 bg-background">
          ...
          <div className="p-2 bg-muted/30 border-b border-border flex gap-1.5 overflow-x-auto text-[11px] shrink-0 no-scrollbar">
            <button 
              ...
              disabled={loading}
              className="px-2.5 py-1 bg-purple-500/10 hover:bg-purple-500/20 text-purple-300 border border-purple-500/30 rounded-full whitespace-nowrap transition-colors flex items-center gap-1"
            >
            ...
            <button 
              ...
              disabled={loading}
              className="px-2.5 py-1 bg-blue-500/10 hover:bg-blue-500/20 text-blue-300 border border-blue-500/30 rounded-full whitespace-nowrap transition-colors flex items-center gap-1"
            >
